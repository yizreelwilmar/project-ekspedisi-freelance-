<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder mb-0">Update User Data</h6>
        </nav>
            ...
            <div class="card-header card-header-primary">
                <div class="row">
                    <div class="col-7 align-items-center pl-4">
                        ...
                        <span class="text-sm mb-0 text-end">Form to update a new user data</span>
                    </div>
                </div>
                <div class="d-flex pt-4" method="post">
                    <div class="col-8">
                        <div class="card border-0 d-flex p-4 pt-0 mb-2 bg-gray-100">
                            <form class="pt-4" action="<?= site_url('admin/updateUser'); ?>" method="post">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="input-group input-group-dynamic mb-4">
                                            ...
                                            <select name="role" class="form-control">
                                                ...
                                                <option value="driver" <?= ($detail['role'] == 'driver') ? 'selected' : ''; ?>>User</option>
                                            </select>
                                        </div>
                                    </div>

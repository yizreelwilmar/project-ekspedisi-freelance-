            ...
            <div class="row">
                ...
                <ul class="list-group">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <span class="mb-3 text-sm">Pengirim : <b><?= $capacity['driver']?>  </b></span>
                    </div>
                    ...
                    <div class="pl-3 d-flex flex-column">
                        <span class="mb-3 text-sm">Berat : <b> <?= $capacity['b_capacity']?> kg </b></span>
                    ...
                    <div class="pl-5 d-flex flex-column">
                        <?php if ( $capacity['b_capacity'] ) : ?>
                            <span class="mb-3 text-sm text-danger"><b> WARNING ! </b></br> Perhatikan Package yang di input</br></span>
                        <?php else : ?>
                    </div>
                    <?php endif ;?> 
                    </li>
            ...
            <div class="card">
                ...
                <form action="<?= site_url('admin/addCapacitys/'); ?>" method="post">
                    <div class="row">
                        ...
                        <h6 class="mb-0">Package And Route Point</h6>

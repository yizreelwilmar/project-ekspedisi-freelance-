...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Process Package</h6>
            </nav>
    ...
    <div class="card-header p-0 w-75 position-fixed mt-n4 mx-2 z-index-2">
        <div class="shadow-dark border-radius-lg d-flex px-5 pt-4 pb-3">
            ...
            <div class="col-4 text-end">
                <a href="<?= site_url('admin/capacity/addcapacity'); ?>" class="btn btn-info btn-sm mb-0">Add Process Data</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card">
            ...
            <div class="table-responsive p-0">
                ...
                <thead>
                        ...
                        <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Sender</th>
                    ...
                    <?php if (!empty($capacity)) : $i = 1; foreach (array_reverse($capacity) as $value) : ?>
                        ...
                        <td class="pl-4">
                            <span class="text-sm font-weight-bold"><?= $value->b_capacity; ?> kg</span>
                        </td>
                        <!-- <td class="pl-4"> 

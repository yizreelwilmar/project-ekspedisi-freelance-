                    ...
                    <div class="card-header pb-2 p-2">
                        <div class="row">
                            <div class="col-6 align-items-center">
                                <span class="text-lg mb-0"><b>Package Information</b><br>
                                    <p class="text-sm mb-2">Date transaction <?= date("d-m-Y", strtotime($package['date'])); ?> </p>
                                </span>
                            </div>
                            <div class="col-3 text-end d-flex">
                                <div class="pl-5 pr-3">
                                    <a href="<?= site_url('admin/package/' . $package['id_package'] . '/update'); ?>" rel="tooltip" title="detail" class="badge btn-info btn-sm mb-0">Edit</a>
                                </div>
                                <div class="pr-3">
                                ...
                                <!-- <div class="pr-3">
                                    <a href="<?= site_url('admin/printSuratJalan/' . $package['id_package'] . ''); ?>" class="badge btn-dark mb-0">Surat Jalan <i class="material-icons text-sm">open_in_new</i></a>
                                </div> -->
                            </div>
                        </div>
                    </div>
                                ...
                                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                    ...
                                    <div class="pl-4 d-flex flex-column">
                                        ...
                                        <?php if (!empty($package['metode_pembayaran'])) : ?>
                                            <span class="mb-3 text-sm">Metode Bayar : <b><br><?= $package['metode_pembayaran'] ?></b></span>
                                        <?php endif; ?>
                        ...
                        <table id="table-data" class="table align-items-center justify-content-center mb-0">
                            ...
                            <tbody class="pl-3">
                                <?php if (!empty($v_package)) : $i = 1;
                                    foreach (array_reverse($v_package) as $value) : ?>
                                        <tr>
                                            <td>
                    ...
                    <form action="<?= site_url('admin/addVolume'); ?>" method="post">
                        <div class="row">
                            <div class="col-7 pl-4 align-items-center">
                                ...
                                <span class="text-sm mb-0">Set package Item</span>
                            </div>
                            <div class="col-3 text-end">
                                <button class="btn btn-info btn-sm mb-0">Add Item</button>
                            </div>
                        </div>
                </div>

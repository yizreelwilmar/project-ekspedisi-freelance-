                    ...
                    <table id="table-data" class="table align-items-center justify-content-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">ID Process</th>
                                <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Pengirim</th>
                                <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Penerima</th>
                        ...
                        <tbody class="pl-3">
                            <?php if (!empty($capacity)) : $i = 1;
                                foreach (array_reverse($capacity) as $value) : ?>
                                    <tr>
                                        <td>
                                        ...
                                        <td class="pl-4">
                                            <span class="text-sm font-weight-bold"><?= $value->id_capacity; ?></span>
                                        </td>
                                        <td class="pl-4">
                                            <span class="text-sm font-weight-bold"><?= $value->driver; ?></span>
                                        </td>
                                        <td class="pl-4">
                                            <span class="text-sm font-weight-bold"><?= $value->package_name; ?></span>
                                        </td>
                                        <td class="pl-4">
...
<script>
    $(document).ready(function() {
        $('#table-data').DataTable({
            "searching": true, // Enables the search feature
            "paging": true, // Enables pagination
            "info": true, // Shows table information (e.g., showing X of Y entries)
            "lengthChange": true, // Enables changing the number of rows displayed
        });
    });
</script>

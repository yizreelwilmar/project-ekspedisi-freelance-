...
class CrudModel extends CI_Model
{
    ...
    // Function to get v_package details based on id
    public function get_v_package_by_id($id)
    {
        ...
        if (!empty($id)) {
            ...
            $query = '
                SELECT * 
                FROM v_package 
                JOIN package ON v_package.id_package = package.id_package 
                JOIN product ON v_package.id_product = product.id_product 
                WHERE v_package.id_package = ?
            ';
